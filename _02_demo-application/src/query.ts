/**
 * Na paleta de comando, encontre e clique em 'tsc: assista - tsconfig.json demo-application'.
 * Tenha o cuidado de selecionar a opção correta, pois haverá alternativas semelhantes (criar opções
 *  para o nosso projeto de contrato inteligente, por exemplo). Você pode precisar rolar a lista para encontrar a tarefa correta.
 */
